...
class CxFastList_Arbiter_false_false_true_false_Shape_Particle {
	...
	public inline function addAll(list:CxFastList_Arbiter_false_false_true_false_Shape_Particle) {
		   {
	...
	public inline function insert(cur:CxFastNode_Arbiter_false_false_true_false_Shape_Particle,o:Arbiter_false_false_true_false_Shape_Particle) {
	...
	public inline function free(o:Arbiter_false_false_true_false_Shape_Particle) {}
