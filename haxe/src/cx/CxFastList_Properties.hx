...
class CxFastList_Properties {
	...
	public inline function addAll(list:CxFastList_Properties) {
		   {
	...
	public inline function insert(cur:CxFastNode_Properties,o:Properties) {
	...
	public inline function free(o:Properties) {}
