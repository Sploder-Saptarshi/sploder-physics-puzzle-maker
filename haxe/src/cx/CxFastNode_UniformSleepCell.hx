...
class CxFastNode_UniformSleepCell {
	public var elt:UniformSleepCell;
	public var next:CxFastNode_UniformSleepCell;
	
	public function new() {}
	
	public inline function elem ():UniformSleepCell return elt
}