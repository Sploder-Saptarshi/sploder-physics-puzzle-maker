...
class CxFastNode_Arbiter_true_true_true_false_Shape_Particle {
	public var elt:Arbiter_true_true_true_false_Shape_Particle;
	public var next:CxFastNode_Arbiter_true_true_true_false_Shape_Particle;
	
	public function new() {}
	
	public inline function elem ():Arbiter_true_true_true_false_Shape_Particle return elt
}