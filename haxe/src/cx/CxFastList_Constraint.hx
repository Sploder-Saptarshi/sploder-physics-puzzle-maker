...
class CxFastList_Constraint {
	...
	public inline function addAll(list:CxFastList_Constraint) {
		   {
	...
	public inline function insert(cur:CxFastNode_Constraint,o:Constraint) {
	...
	public inline function free(o:Constraint) {}
