...
class CxFastList_Arbiter_true_true_true_true_Shape_Shape {
	...
	public inline function addAll(list:CxFastList_Arbiter_true_true_true_true_Shape_Shape) {
		   {
	...
	public inline function insert(cur:CxFastNode_Arbiter_true_true_true_true_Shape_Shape,o:Arbiter_true_true_true_true_Shape_Shape) {
	...
	public inline function free(o:Arbiter_true_true_true_true_Shape_Shape) {}
