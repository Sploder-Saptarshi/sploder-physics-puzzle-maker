...
import cx.CxFastList_UniformCell;
	...
	typedef CxMixList_Axis =  Axis;
	typedef CxMixIterator_Axis =  Axis;

	typedef CxMixList_GeomVert =  GeomVert;
	typedef CxMixIterator_GeomVert =  GeomVert;

	typedef CxMixList_Vec2 =  Vec2;
	typedef CxMixIterator_Vec2 =  Vec2;

	typedef CxMixList_Shape =  Shape;
	typedef CxMixIterator_Shape =  Shape;
