...
class CxFastList_Arbiter {
	...
	public inline function addAll(list:CxFastList_Arbiter) {
		   {
	...
	public inline function insert(cur:CxFastNode_Arbiter,o:Arbiter) {
	...
	public inline function free(o:Arbiter) {}
