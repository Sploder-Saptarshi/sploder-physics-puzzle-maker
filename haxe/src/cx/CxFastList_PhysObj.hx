...
class CxFastList_PhysObj {
	...
	public inline function addAll(list:CxFastList_PhysObj) {
		   {
	...
	public inline function insert(cur:CxFastNode_PhysObj,o:PhysObj) {
	...
	public inline function free(o:PhysObj) {}
