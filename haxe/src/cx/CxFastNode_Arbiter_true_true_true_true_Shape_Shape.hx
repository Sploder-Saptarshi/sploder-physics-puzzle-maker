...
class CxFastNode_Arbiter_true_true_true_true_Shape_Shape {
	public var elt:Arbiter_true_true_true_true_Shape_Shape;
	public var next:CxFastNode_Arbiter_true_true_true_true_Shape_Shape;
	
	public function new() {}
	
	public inline function elem ():Arbiter_true_true_true_true_Shape_Shape return elt
}