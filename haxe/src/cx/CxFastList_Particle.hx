...
class CxFastList_Particle {
	...
	public inline function addAll(list:CxFastList_Particle) {
		   {
	...
	public inline function insert(cur:CxFastNode_Particle,o:Particle) {
	...
	public inline function free(o:Particle) {}
