...
class CxFastList_UniformSleepCell {
	...
	public inline function addAll(list:CxFastList_UniformSleepCell) {
		   {
	...
	public inline function insert(cur:CxFastNode_UniformSleepCell,o:UniformSleepCell) {
	...
	public inline function free(o:UniformSleepCell) {}
