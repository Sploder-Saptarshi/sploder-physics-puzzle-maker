...
class CxFastList_Contact {
	...
	public inline function addAll(list:CxFastList_Contact) {
		   {
	...
	public inline function insert(cur:CxFastNode_Contact,o:Contact) {
	...
	public inline function free(o:Contact) {}
