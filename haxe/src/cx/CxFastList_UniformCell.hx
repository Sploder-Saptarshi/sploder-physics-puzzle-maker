...
class CxFastList_UniformCell {
	...
	public inline function addAll(list:CxFastList_UniformCell) {
		   {
	...
	public inline function insert(cur:CxFastNode_UniformCell,o:UniformCell) {
	...
	public inline function free(o:UniformCell) {}
