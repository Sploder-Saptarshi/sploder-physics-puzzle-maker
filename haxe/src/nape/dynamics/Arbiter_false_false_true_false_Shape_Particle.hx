...
class Arbiter_false_false_true_false_Shape_Particle extends Arbiter {
	
	public var next:Arbiter_false_false_true_false_Shape_Particle;
	...
	public inline function retire() {
		if(p1!=null) {
			p1.p_arbiters_false_false_true_false_Shape_Particle.remove(this);
			p2.p_arbiters_false_false_true_false_Shape_Particle.remove(this);
		}
		live  = false;
		woken = true;
		updated = false;
		...
		alloc.CxFree_Arbiter_false_false_true_false_Shape_Particle(this);
		stamp = 0;
	}
	...
	public inline function assign(s1:Shape,s2:Particle,ID:Int) {
		...
		p1.p_arbiters_false_false_true_false_Shape_Particle.add(this);
		p2.p_arbiters_false_false_true_false_Shape_Particle.add(this);
