...
class Arbiter_true_true_true_true_Shape_Shape extends Arbiter {
	
	public var next:Arbiter_true_true_true_true_Shape_Shape;
	...
	public inline function retire() {
		if(p1!=null) {
			p1.p_arbiters_true_true_true_true_Shape_Shape.remove(this);
			p2.p_arbiters_true_true_true_true_Shape_Shape.remove(this);
		}
		live  = false;
		woken = true;
		updated = false;
		...
		alloc.CxFree_Arbiter_true_true_true_true_Shape_Shape(this);
		stamp = 0;
	}
	...
	public inline function assign(s1:Shape,s2:Shape,ID:Int) {
		...
		p1.p_arbiters_true_true_true_true_Shape_Shape.add(this);
		p2.p_arbiters_true_true_true_true_Shape_Shape.add(this);
