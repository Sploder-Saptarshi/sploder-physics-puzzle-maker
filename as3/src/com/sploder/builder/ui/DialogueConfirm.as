package com.sploder.builder.ui 
{
	...
	public class DialogueConfirm extends Dialogue
	{
		...
		public function DialogueConfirm (creator:Creator, width:int = 300, height:int = 150, title:String = "Title", buttons:Array = null) 
		{
		...
		{
			if (_callback != null) _callback.apply(_callbackObject, _callbackArgs);
		}
