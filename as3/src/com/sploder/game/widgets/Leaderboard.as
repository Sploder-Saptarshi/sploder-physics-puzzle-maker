            ...
            if (src != null) {
                ...
                if (src != prev_src) {
                    ...
                    if (src != "<empty />") {
						...
						var noscores:Sprite = Game.library.getDisplayObject("noScoresSymbol") as Sprite;
        ...
        public function populate ():void {
			...
			for each (var score:XML in boardXML..score) {
                ...
                if (container["score_" + i] == undefined) {
					...
					scoreMC = Game.library.getDisplayObject("scoreSymbol") as Sprite;
            ...
            if (i < 15) {
                ...
                for (i = i; i < 16; i++) {
                    ...
                    if (container["score_" + i] == undefined) {
						...
						scoreMC = Game.library.getDisplayObject("scoreSymbolEmpty") as Sprite;
						container.addChild(scoreMC);
