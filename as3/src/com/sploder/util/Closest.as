	...
	public class Closest {
		...
		* given point. */
		...
		public static function distanceFromLine (origin:Point, linePtA:Point, linePtB:Point):Number {
			...
			var closestPoint:Point = pointClosestTo(origin, linePtA, linePtB);
		...
		//
		//
		public static function closestPtSegmentSegment (p1:Point, q1:Point, p2:Point, q2:Point):Object {
			...
			if (a <= EPSILON && e <= EPSILON) {
				...
				return { c1: c1, c2: c2, dist: dist, s: s, t: t };
			...
			var p1v:Vector2d = new Vector2d(p1);
			var p2v:Vector2d = new Vector2d(p2);
			
			c1 = p1v.getSum(d1.getScaled(s));
			c2 = p2v.getSum(d2.getScaled(t));
