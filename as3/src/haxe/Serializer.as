package haxe
{
	...
	public class Serializer
	{
		...
		{
			this.buf = new haxe.StringBuf();
			this.cache = new Array();
			this.useCache = haxe.Serializer.USE_CACHE;
			this.useEnumIndex = haxe.Serializer.USE_ENUM_INDEX;
			this.shash = new haxe.Hash();
			this.scount = 0;
		}
		...
		{
			{
				...
				switch ($e.index)
				{
					...
					case 5: 
						...
						break;
					default: 
						throw "Cannot serialize " + haxe.Std.string(v);
						break;
				}
			}
		}
		...
		protected var shash:haxe.Hash;
		protected var cache:Array;
		protected var buf:haxe.StringBuf;
