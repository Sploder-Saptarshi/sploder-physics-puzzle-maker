	...
	public class Unserializer {
		...
		public function unserialize() : * {
			...
			case 100:
			{
				...
				return haxe.Std._parseFloat(this.buf.substr(p1,this.pos - p1));
			}
			break;
			case 121:
			{
			...
			case 113:
			{
				var h1 : haxe.IntHash = new haxe.IntHash();
				this.cache.push(h1);
		...
		protected function unserializeObject(o : *) : void {
			while(true) {
				...
				if(!haxe.Std._is(k,String)) throw "Invalid object key";
